                ...
                <div class="modal-body p-4 bg-light">
                    <div class="row">
                        ...
                        <div class="col-lg">
                            ...
                            <input type="date" name="date_of_birth" class="form-control" placeholder="Last Name"
                                required>
                        </div>
                    </div>
                    <div class="my-2">
                    ...
                    <div class="my-2">
                        ...
                        <input type="date" name="relieving_date" class="form-control" required>
                    </div>
                    <div class="my-2">
        ...
        <div class="modal-content">
            ...
            <form action="#" method="POST" id="edit_employee_form" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4 bg-light">
                    ...
                    <div class="my-2">
                        <label for="relieving_date">Relieving Date</label>
                        <input type="date" name="relieving_date" id="relieving_date" class="form-control" required>
                    </div>
                    <div class="my-2">
                        <label for="contact">Contact No</label>
            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <div class="card-header bg-success d-flex justify-content-between align-items-center">
                        <h3 class="text-light"> Employees Management</h3>
                        <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addEmployeeModal"><i
                                class="bi-plus-circle me-2"></i>Add New Employee</button>
                    </div>
                    <div class="card-header   align-items-center">
                        <h3 class="text-success text-center"> Employees List</h3>
      ...
      $(document).on('click', '.editIcon', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#relieving_date").val(response.relieving_date);
